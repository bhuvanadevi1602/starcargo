                 ...
                 <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="submit" name="search" id="search" class="btn btn-sm btn-de-primary csv p-2" value="Search" />
                        <a href="exportdetails.php?export&fromdate=<?= $fromdate ?>&todate=<?= $todate ?>" class="btn btn-sm btn-de-primary csv p-2" target="_blank">Export CSV</a>
                   </div>
                  ...
                  <table class="table" id="datatable_1">
                    ...
                    <tbody>
                      ...
                      if (isset($_POST['search'])) {
                        ...
                        $sqlbook = "SELECT * from booking where (creationdate>='$fromdate' and creationdate<='$todate')  ORDER BY id ASC";
        ...
        $(document).ready(function() {
          ...
          $("#weight").change(function() {
            ...
            if (gst == 'State') {
              ...
              var gstamt = parseFloat(amount) + parseFloat(gsttot1) + parseFloat(gsttot2) + parseFloat(others);
              $("#paid").val(gstamt);
            } else if (gst == 'Interstate') {
              $("#states").show();
              $("#sgst").hide();
              ...
              var gstamt = parseFloat(amount) + parseFloat(gsttot1) + parseFloat(others);
              $("#paid").val(gstamt);
            } else {
              var amount = $("#amount").val();
              $("#paid").val(amount);
