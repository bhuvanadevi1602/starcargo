                            ...
                            <div class="card-body">
                                <form class="row g-3 needs-validation" novalidate action="" method="POST">
                                  <input type="hidden" name="ed_userid" id="ed_userid" />
                                    ...
                                    <div class="col-12">
                                      <input type="submit" name="ed_usercreation" id="ed_usercreation" class="btn btn-primary" value="Create">
                                    </div>
                                </form><!--end form-->                                          
                            </div><!--end card-body-->
                  ...
                  <table class="table" id="datatable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td> <button type="button" class="btn btn-primary btn-sm edit_user" data-bs-toggle="modal" data-bs-target="#edituser" ids="<?=$res['id']?>">
                                                        Edit
                                                    </button>
                                                    </td>
                                                     <td> 
